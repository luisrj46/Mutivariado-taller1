...
\begin{frame}{Distribuciones de las variables}
  \small
  Las distribuciones muestran asimetría positiva y valores extremos. Por eso se aplicó \texttt{log1p} antes del ACP.

  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \img{Graficos de resultados/distribuciones fisico-quimica_grupo_A.png}{1.0}
    \end{column}
    \begin{column}{0.5\textwidth}
      \img{Graficos de resultados/distribuciones fisico-quimica_grupo_B.png}{1.0}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Nube de individuos}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      \img{Graficos de resultados/Nube de individuos.png}{1.0}
    \end{column}
    \begin{column}{0.48\textwidth}
      \small
      \begin{itemize}
        \item Cada punto representa una observación espacio-temporal.
        \item Puntos cercanos al origen: perfiles más promedio.
        \item Puntos alejados: perfiles físico-químicos diferenciados.
        \item El color por coseno cuadrado indica qué tan bien queda representado el individuo en el plano 1-2.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}

\begin{frame}{Biplot y atípicos}
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
